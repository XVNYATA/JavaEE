    ...
    <div class="bodytextmenu" id="shumenu">
	    <div class="shumenu" >
	    	<div >
				...
				d.add(4,1,'角色管理',"javascript:parent.mainframe.addTab('2','角色管理','http://www.taobao.com')",'角色管理',"mainframe");
				d.add(5,1,'模块管理',"javascript:parent.mainframe.addTab('2','模块管理','http://www.taobao.com')",'模块管理',"mainframe");
				d.add(6,2,'假期审批','');
				d.add(7,2,'假期明细','');
				d.add(8,2,'假期类型','');
