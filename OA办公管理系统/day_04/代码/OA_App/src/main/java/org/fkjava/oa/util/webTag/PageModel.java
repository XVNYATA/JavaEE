package org.fkjava.oa.util.webTag;
...
public class PageModel {
	...
	public int getPageIndex() {
		System.out.println("this.getTotalSize():"+this.getTotalSize()+" pageIndex:"+pageIndex);
	...
	public int getTotalSize() {
		System.out.println("this.getRecordCount():"+this.getRecordCount());
