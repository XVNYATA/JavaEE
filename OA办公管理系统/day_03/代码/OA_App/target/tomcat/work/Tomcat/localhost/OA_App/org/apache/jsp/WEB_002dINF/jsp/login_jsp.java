 ...
 * Generated at: 2016-09-05 08:19:44 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t  \r\n");
      out.write("\t  if(window.location !=top.window.location){\r\n");
      out.write("\t\t  //将当前页面作为最顶级页面\r\n");
      out.write("\t\t  top.window.location = window.location;\r\n");
      out.write("\t  }\r\n");
      out.write("\t\r\n");
      out.write("\t  $(function(){\r\n");
      ...
      out.write("\t\t\t\t$.messager.alert('温馨提示',\"请输入用户名！\",'warning');\r\n");
      out.write("\t\t\t\t$(\"#userName\").focus();\r\n");
      out.write("\t\t\t}else if(!/^[0-9a-zA-Z]{5,16}$/.test(loginName)){\r\n");
      out.write("\t\t\t\t$.messager.alert('温馨提示',\"您输入的用户名不合法，只能输入字母以及数字，请核实！\",'warning');\r\n");
      out.write("\t\t\t\t$(\"#userName\").val(\"\");\r\n");
      out.write("\t\t\t\t$(\"#userName\").focus();\r\n");
      out.write("\t\t\t}else if($.trim(password)==null||$.trim(password)==\"\"){\r\n");
      out.write("\t\t\t\t$.messager.alert('温馨提示',\"请输入密码！\",'warning');\r\n");
      out.write("\t\t\t\t$(\"#password\").focus();\r\n");
      out.write("\t\t\t}else if(!/^[0-9a-zA-Z]{5,16}$/.test(password)){\r\n");
      out.write("\t\t\t\t$.messager.alert('温馨提示',\"您输入的密码不合法，只能输入字母以及数字，请核实！\",'warning');\r\n");
      out.write("\t\t\t\t$(\"#password\").val(\"\");\r\n");
      out.write("\t\t\t\t$(\"#password\").focus();\r\n");
      out.write("\t\t\t}else if(!/^[0-9]{4}$/.test(vcode)){\r\n");
      out.write("\t\t\t\t$.messager.alert('温馨提示',\"您输入的验证码不正确！\");\r\n");
      ...
      out.write("\t\t\t\t\t\t$.messager.alert('温馨提示',\"数据加载异常！\",'warning');\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t})\r\n");
