...
public class BaseDaoHibernate4<T> implements BaseDao<T>
{
	...
	{
//		this.delete(this.get(entityClazz, id));
	...
	// this.find(hql,"jack","123456");
	// String hql = select b from Book b where b.author = ?
	// this.find(hql,"李刚");
	// 根据带占位符参数HQL语句查询实体
	@SuppressWarnings("unchecked")
