 ...
 * Generated at: 2016-09-09 09:40:37 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\talert(\"您输入的用户名不合法，请重新输入。\");\r\n");
      out.write("\t\t\t\t\t$(\"#userName\").val(\"\");\r\n");
      out.write("\t\t\t\t\t$(\"#userName\").focus();\r\n");
      out.write("\t\t\t\t}else if($.trim(password)==null||$.trim(password)==\"\"){\r\n");
      out.write("\t\t\t\t\talert(\"请输入您的密码\");\r\n");
      out.write("\t\t\t\t\t$(\"#password\").focus();\r\n");
      out.write("\t\t\t\t}else if(!/^[0-9a-zA-Z]{6,10}$/.test(password)){\r\n");
      out.write("\t\t\t\t\talert(\"您输入的密码不合法，请重新输入。\");\r\n");
