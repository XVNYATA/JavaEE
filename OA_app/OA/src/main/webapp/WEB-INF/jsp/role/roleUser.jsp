		...
		$(function(){
			$("#unbindUser").click(function(){
				...
				var boxes = $("input[id^=box_]:checked");
					if(boxes.length==0){
						$.messager.alert("温情提示","请选择您要接触绑定的用户","warning");
					}else{
						var arr = new Array();
						//jquery对象遍历的时候都会变成dom对象
						$.each(boxes,function(){
							arr.push(this.value);
						})
						//发送解除请求
...
<body style="width: 100%;height: 100%;overflow:hidden">
	...
	<fk:page pageIndex="${pageModel.pageIndex}" 
				  ...
				  pageStyle="digg"
				  submitUrl="${ctx}/role/selectRoleUser.jspx?pageModel.pageIndex={0}&role.id=${role.id}"/>
