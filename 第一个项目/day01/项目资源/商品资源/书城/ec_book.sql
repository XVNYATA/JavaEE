...
insert into `ec_ARTICLE` (`ID`, `TITLE`, `supplier`, `PRICE`, `locality`, `putaway_date`, `storage`, `IMAGE`, `DESCRIPTION`, `TYPE_CODE`, `CREATE_DATE`) values('9','林格伦作品选（9册/套）{最新精装典藏版}——长袜子皮皮之母林格伦作品精选集，累积销售1000多万册的儿童文学传世经典',NULL,'179.6',NULL,NULL,'100','21094590-1_a.jpg','00020001','2012-06-11');
...
insert into `ec_ARTICLE` (`ID`, `TITLE`, `supplier`, `PRICE`, `locality`, `putaway_date`, `storage`, `IMAGE`, `DESCRIPTION`, `TYPE_CODE`, `CREATE_DATE`) values('13','用美国小孩的方法学英文（图解英语训练营全两册）',NULL,'48.1',NULL,NULL,'100','21035452-1_a.jpg','00020001','2012-06-11');
insert into `ec_ARTICLE` (`ID`, `TITLE`, `supplier`, `PRICE`, `locality`, `putaway_date`, `storage`, `IMAGE`, `DESCRIPTION`, `TYPE_CODE`, `CREATE_DATE`) values('14','我爱写作文：小学生牛牛提高写作能力的36个趣味故事(上市1年多来，超过3万名家长指导孩子写作的趣味宝典)',NULL,'11.9',NULL,NULL,'100','20915608-1_a.jpg','00010002','2012-06-11');
...
insert into `ec_ARTICLE` (`ID`, `TITLE`, `supplier`, `PRICE`, `locality`, `putaway_date`, `storage`, `IMAGE`, `DESCRIPTION`, `TYPE_CODE`, `CREATE_DATE`) values('16','霍金经典著作套装（全4册）：时间简史（插图本）/果壳中的宇宙/大设计/霍金传（当当独家火热发售）',NULL,'108.8',NULL,NULL,'100','22564594-1_a.jpg','00010002','2012-06-11');
insert into `ec_ARTICLE` (`ID`, `TITLE`, `supplier`, `PRICE`, `locality`, `putaway_date`, `storage`, `IMAGE`, `DESCRIPTION`, `TYPE_CODE`, `CREATE_DATE`) values('18','探索》（全14册）探索宇宙奥秘,让孩子的思维更加广阔。',NULL,'291.2',NULL,NULL,'100','22635929-1_a.jpg','00010002','2012-06-11');
