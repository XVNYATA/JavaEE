			...
			<td>
				<table width="100%">
					<tr>
						...
						<form id="articleForm" 
							  action="${pageContext.request.contextPath }/admin/article?method=update" 
							  method="post" 
						...
						<fieldset style="width:400px;">
							...
							<table>
								...
								<tr>
									...
									<td>
										<input type=text name="putawayDate" id="putawayDate" size="50" value="<fmt:formatDate value='${article.putawayDate }' pattern='yyyy-MM-dd'/>"/>
									</td>
								</tr>
								<tr>
