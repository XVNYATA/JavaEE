...
<body>
	...
	<form name="loginform" method="post" action="login.action"
		id="loginform">
		<br /> <input type="hidden" name="step" value="1" /> <input
			type="hidden" name="order" value="" />
		<div class="login_main"
			style="background: url(images/login_bg.jpg) no-repeat center 0;">
					...
					<div class="login_frame_border">
						<div class="login_frame">
							<div class="login_title">
								<i></i>还不是商城用户？&nbsp;&nbsp;<a href="register.action">立即注册</a>
							</div>
							<div class="login_frist clearfix" id="user_div_name">
								<label>登录名</label>
								<span class="login_input">
								<input
									name="loginName" type="text" maxlength="40"
									id="loginName" class="tip" />
								</span>
								<span class="hint" id="login_loginname_error"
									style="display: none">
								</span> <span class="hint"
									id="usernameMessage" style="display: black">请输入邮箱地址</span>
							</div>
							<p class="clearfix" id="password_div">
								...
								<span class="hint" id="login_password_error"
									style="display: none"></span>
								<span class="hint"
									id="passwordMessage" style="display: black">请输入6-16位密码</span>
							</p>
